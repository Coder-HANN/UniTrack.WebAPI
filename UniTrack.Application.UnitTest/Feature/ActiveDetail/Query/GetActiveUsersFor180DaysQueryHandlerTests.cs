...
{
    public class GetActiveUsersFor180DaysQueryHandlerTests
    {
        private readonly Mock<ICurrentUserServices> _currentUserMock;
        private readonly Mock<IUserRepository> _userRepositoryMock;
        private readonly Mock<ILocalizationService> _localizationMock;

        private readonly GetActiveUsersFor180DaysQueryHandler _handler;

        public GetActiveUsersFor180DaysQueryHandlerTests()
        {
            _currentUserMock = new Mock<ICurrentUserServices>();
            _userRepositoryMock = new Mock<IUserRepository>();
            _localizationMock = new Mock<ILocalizationService>();

            _handler = new GetActiveUsersFor180DaysQueryHandler(
        ...
        public async Task Handle_UserIsNotAdmin_ShouldReturnNotAuthorized()
        {
            ...
            // Act
            var result = await _handler.Handle(new GetActiveUsersFor180DaysQuery(), CancellationToken.None);
            ...
            _userRepositoryMock.Verify(x => x.Get180DaysActiveUsersCountAsync(), Times.Never);
        }
        ...
        public async Task Handle_AdminUser_ActiveUsersGreaterThanZero_ShouldReturnCount()
        {
            ...
            _userRepositoryMock.Setup(x => x.Get180DaysActiveUsersCountAsync())
                .ReturnsAsync(15);
