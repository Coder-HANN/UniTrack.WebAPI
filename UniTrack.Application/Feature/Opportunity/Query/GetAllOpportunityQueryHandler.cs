...
{
    public class GetAllOpportunityQueryHandler : IRequestHandler<GetAllOpportunityQuery, ServiceResponse<IPagingExecutionResult<GetAllOpportunityResponseDTO>>>
    {
        ...
        public GetAllOpportunityQueryHandler(
        ...
        public async Task<ServiceResponse<IPagingExecutionResult<GetAllOpportunityResponseDTO>>> Handle(GetAllOpportunityQuery request, CancellationToken cancellationToken)
        {
            ...
            {
                var opportunityUser = userId.HasValue? o.OpportunityUsers.FirstOrDefault(ou => ou.UserId == userId.Value): null;
